...
export const MSG = {
	...
	errInsufficientBalance: "残高不足です (現在 {total} lsp)",
	...
	notifyApplyBodySubmit: "提出報酬: {pt} lsp (付与済み)",
	notifyApplyBodyComplete: "完了報酬: {pt} lsp (承認後に付与)",
	notifyApplyBodyFooter: "アプリで承認してください。",
	notifyRejectBody: "{user} の「{label}」が訂正依頼になりました。内容を見直して再提出してください。",
	notifyCashoutBody: "{user} が {amount} lsp を使いました。\n残高: {balance} lsp",
} as const;
